...
```
- [ ] `robot.txt` file. it will be used by search engines and you can have a blacklist for paths that you don't want to index via search engines. some  [more info](https://moz.com/learn/seo/robotstxt)
