...
By adding last modified to site map file you can tell google bot that the content of the page has been changed and need re-crawl. Be aware that google bot would evaluate your changes and if the page change would be minor and not worth re-crawling it will understand and won't trust your last modified property anymore so keep that in mind.[more info](https://www.youtube.com/watch?v=am4g0hXAA8Q&t=926s)
